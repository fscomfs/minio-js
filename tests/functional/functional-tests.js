...
describe('functional tests', function () {
  ...
  if (process.env['SERVER_ENDPOINT']) {
    ...
    clientConfigParams.sessionToken =
      'eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9..xaCJYMRxvmKnqSszNKuFMHRXC19mS6BW_zam0oIavseHu12ikIjzz2NcvchofpXPsKad0FQjrEk8OhE-gj5ncA'
  }
  ...
  describe('removeDir', () => {
    step('removeDir(bucketName, objectName)', (done) =>
      client
        .removeDir('cvmart-filesystem', 'dev-cvmart-27/dir1/')
        .then((dirInfo) => {
          done(dirInfo)
        })
        .catch((e) => {
